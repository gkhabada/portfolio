...
/* harmony import */ var _sass_reset_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3);
/* harmony import */ var _sass_reset_scss__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_sass_reset_scss__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _sass_fonts_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(8);
...
/* harmony import */ var _sass_screen_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(10);
/* harmony import */ var _sass_screen_scss__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_sass_screen_scss__WEBPACK_IMPORTED_MODULE_2__);
...
$(document).ready(function () {
  ...
  var now = new Date();
  $(".footer_date").text(now.getFullYear()); // about me old

  var wasBorn = new Date(1995, 4, 7);
  $(".about-me__old").text(Math.floor((now - wasBorn) / 31536000000)); //loader

  setTimeout(function () {
    return $('.loader').hide(100);
  }, 200);
}); // parallax photo

$(document).ready(function () {
  var imgBlock = document.querySelector('.about-me');
  var imgMy = document.querySelector('.about-me__photo');
...
$(document).ready(function () {
  var dn = localStorage.getItem('dayNight');
  dn = JSON.parse(dn);
...
var aboutMeImg = document.querySelector('.about-me__photo img');

function dayNight() {
  var t = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
  var now = Number(new Date().toLocaleTimeString().substring(0, 2));
...
var allWorks = null;
var promise = fetch('works.json').then(function (response) {
...
var showedWorkdIndex = 0;
var worksDiv = document.querySelector('.works');

function addWorks(works) {
  if (works !== null && works.length >= showedWorkdIndex) {
    for (var i = showedWorkdIndex; i < showedWorkdIndex + 8; i++) {
      if (works[i] !== undefined) {
        var work = "\n        <div class=\"work\">\n          <div class=\"work_hover\">\n            <h3 class=\"work__title\">".concat(works[i].title, "</h3>\n            <p class=\"work__text\">").concat(works[i].text, "</p>\n            <a href=\"").concat(works[i].link, "\" class=\"work__link\" target=\"_blank\">\u041E\u0442\u043A\u0440\u044B\u0442\u044C</a>\n          </div>\n          <img src=\"").concat(works[i].img, "\" alt=\"").concat(works[i].title, "\" title=\"").concat(works[i].title, "\">\n        </div>\n        ");
...
document.querySelector('.portfolio__show-more').addEventListener('click', function () {
  addWorks(allWorks);
});
